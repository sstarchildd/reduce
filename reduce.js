...
as the vowel and the values as the number of times the vowel appears in the string. This function 
...
function vowelCount(str) {
    ...
    return str.split('').reduce(function(accum,nextValue){
        let neVowelCount = nextValue.toLowerCase()
        if(vowel.indexOf(neVowelCount) !== -1){
            if(accum[neVowelCount]){
                accum[neVowelCount]++;
            } else {
                accum[neVowelCount] = 1;
            }
        }
        return accum;
    }, {});
